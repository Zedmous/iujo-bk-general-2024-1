...
import { RoleModel, UserModel, TypeTransportModel } from "../models";
...
const TypeTransport = db.define('typetransport',TypeTransportModel);
...
syncModels();
//export default db;
export  { User, Role, TypeTransport,  db };
