...
import { create, deleted, getAll, getOne, update } from "../services/components.service";
export class ComponentsController {
  ...
  createComponents = async (req: Request, res: Response) => {
  ...
  updateComponents = async (req: Request, res: Response) => {
    const {id}=req.params
  ...
  deleteComponents = async (req: Request, res: Response) => {
    const {id}=req.params
