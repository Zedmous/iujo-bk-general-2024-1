...
import { TableTypeController } from "../controllers"; // Your controller for TTables
import { TableTypeValidator } from "../validators"; // Your validator for TTables

const tTablesValidator = new TableTypeValidator(); // Create a new validator instance
const router = Router();
const tTablesController = new TableTypeController(); // Create a new controller instance
