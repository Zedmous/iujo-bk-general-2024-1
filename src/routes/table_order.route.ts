...
router.post("/",tableOrderValidator.validateOrder,validateFields, tableOrderController.createOrder);//http://localhost:3800/api/order
router.put("/:id",tableOrderValidator.validateOrder,validateFields, tableOrderController.updateOrder);//http://localhost:3800/api/order/1
